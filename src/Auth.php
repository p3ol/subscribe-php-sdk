...
class Auth
{
     ...
     * </code>
     */
    public function createCallback($grantType, $redirectUri, $username = null, $password = null, $reqOptions = [])
    {
        $json = [
            'grantType' => $grantType,
        ...
        $callback = $this->client->request(array_merge($reqOptions, [
            'method' => 'POST',
     ...
     * </code>
     */
    public function verifyCallback($callbackId, $reqOptions = [])
    {
        $callback = $this->client->request(array_merge($reqOptions, [
            'method' => 'POST',
